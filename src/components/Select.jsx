...
const Select = ({ language, onLanguageChange }) => {
  ...
  return (
    <div className='relative flex items-center'>
        ...
        className='w-full px-9 py-1 text-[1rem] appearance-none border-[0.0625rem] border-input-border rounded-[0.25rem] bg-bg-input opacity-100'>
